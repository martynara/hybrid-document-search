...
from Application.Pipelines.Indexing.IndexingQueriesPipeline import IndexingQueriesPipeline
...
def clear_qdrant():
    ...
    collection_name = "documents_queries"
...
def main():
    ...
    # Index pipeline
    indexing_queries_pipeline = IndexingQueriesPipeline()
    ...
    for i, json_file in enumerate(json_files):
        ...
        for document in chunked_documents.documents:
            indexing_queries_pipeline.process_document(document)
            logger.info(f"Successfully indexed queries for document {document.document_id}")

        logger.info(f"Successfully indexed queries for {json_file}")
