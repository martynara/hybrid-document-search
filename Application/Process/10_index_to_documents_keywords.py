...
from Application.Pipelines.Indexing.IndexingKeywordsPipeline import IndexingKeywordsPipeline
...
def clear_qdrant():
    ...
    collection_name = "documents_keywords"
...
def main():
    ...
    # Index pipeline
    indexing_keywords_pipeline = IndexingKeywordsPipeline()
    ...
    for i, json_file in enumerate(json_files):
        ...
        for document in chunked_documents.documents:
            indexing_keywords_pipeline.process_document(document)
            logger.info(f"Successfully indexed keywords for document {document.document_id}")

        logger.info(f"Successfully indexed keywords for {json_file}")
